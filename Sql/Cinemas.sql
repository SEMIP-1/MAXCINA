insert into Cinemas (Name, Description, CinemaLogo, Address) values ('Photospace', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.
